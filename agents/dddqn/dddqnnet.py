...
class DDDQNNet:
    def __init__(self, state_size, action_size, initial_learning_rate, name):
        ...
        with tf.variable_scope(self.name):
            ...
            self.value_fc = tf.keras.layers.LSTM(32, activation='relu')(self.conv_first1)
            ...
            self.advantage_fc = tf.keras.layers.LSTM(32, activation='relu')(self.conv_first1)
