...
if __name__ == "__main__":
    ...
    parser.add_argument('--lstm_lookback', type=int, default=3)
    ...
    ac_dict = {0: 1, 1: 1.5, 2: 2}
    # ac_dict = {0: 1, 1: 1.2, 2: 1.4, 3: 1.6, 4: 1.8, 5: 2.0, 6: 2.2, 7: 2.4, 8: 2.6, 9: 2.8, 10: 3.0}
    # ac_dict = {0: 0.8, 1: 0.85, 2: 0.9, 3: 0.95, 4: 1, 5: 1.05, 6: 1.1, 7: 1.15, 8: 1.2}
    # ac_dict = {0: 0.5, 1: 1, 2: 2}
    # ac_dict = {0: 0.5, 1: 0.6, 2: 0.7, 3: 0.8, 4: 0.9, 5: 1.0, 6: 1.1, 7: 1.2, 8: 1.3, 9: 1.4, 10: 1.5}
    # ac_dict = {0: 0.1, 1: 0.25, 2: 0.5, 3: 0.75, 4: 1, 5: 1.25, 6: 1.5, 7: 1.75, 8: 2}
    # ac_dict = {0: 0, 1: 1}
    # ac_dict = {0: 0.5, 1: 1, 2: 1.5, 3: 2}
