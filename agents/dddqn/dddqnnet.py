    ...
    def __init__(self, state_size, action_size, initial_learning_rate, name):
        ...
        with tf.variable_scope(self.name):
            ...
            self.conv_first1 = tf.keras.layers.LSTM(64, return_sequences=True,
                                                    activation='relu', kernel_initializer='he_normal')(self.inputs_)
            ...
            self.value_fc = tf.keras.layers.LSTM(32, activation='relu', kernel_initializer='he_normal')(self.conv_first1)
            ...
            self.advantage_fc = tf.keras.layers.LSTM(32, activation='relu', kernel_initializer='he_normal')(self.conv_first1)
