...
if __name__ == "__main__":
    ...
    test_months = test_months[:args.num_of_test_months]
    ...
    # ac_dict = {0: 0, 1: 1}
    # ac_dict = {0: 0, 1: 0.5, 2: 1, 3: 1.5, 4: 2}
    ...
    print("Target Network Update (days):    ", args.target_network_update)
    print("Replay Buffer Size:              ", args.memory_size)
    print("Network Update Period (loop):    ", args.network_update)
