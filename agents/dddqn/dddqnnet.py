...
class DDDQNNet:
    def __init__(self, state_size, action_size, initial_learning_rate, name):
        ...
        with tf.variable_scope(self.name):
            ...
            # define network
            # Input is 100x120x4
            self.conv_first1 = tf.keras.layers.LSTM(32, return_sequences=True)(self.inputs_)
            ...
            self.value_fc = tf.keras.layers.Dense(32)(self.conv_first1)
            ...
            self.advantage_fc = tf.keras.layers.Dense(32)(self.conv_first1)
